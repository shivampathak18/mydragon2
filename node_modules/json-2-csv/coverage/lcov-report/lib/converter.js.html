...
<html lang="en">
<head>
    <title>Code coverage report for lib/converter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/converter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; converter.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    opts.DELIMITER = _.defaults(opts.DELIMITER || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> defaultOptions.DELIMITER);
&nbsp;
